...
Route::middleware('auth:api')->group(function(){
    ...
    Route::get('/contents/{id}/komentar', [App\Http\Controllers\Api\KomentarController::class, 'index']);
    Route::post('/contents/{id}/komentar', [App\Http\Controllers\Api\KomentarController::class, 'store']); 
    ...
    //Route::get('/contents/{id}/komentar',[App\Http\Controllers\Api\KomentarController::class,'showKomentarbyUser']);
});

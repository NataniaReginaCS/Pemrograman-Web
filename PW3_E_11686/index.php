...
<html>
    ...
    <body>
        <header class="fixed-top" id="navbar">
            <nav class="container d-flex justify-content-beetween align-items-center py-2">
        ...
        <main>
                ...
                <!-- Featurettes-->
                 <div class="row featurette" style="background-image: url('./assets/images/employee.jpg');
                    ...
                    <div class="col-md-7 offset-md-5" style="background-color: rgba(0, 0, 0, 0.6); padding: 10px 20px;
                                border-radius: 12px; color: white; display: flex; align-items: cemter;">
                        <div>
                            <h2 class="featurette-heading fw-normal">
                                Restauran dengan cita rasa <strong>yang fantastis</strong><div class=""></div>
                            </h2>
                            <p class="lead">
                                Diciptakan oleh <strong>[Natania Regina Clarabella Serafina]</strong>,
                                mahasiswa Universitas Atma Jaya Yogyakarta dari program studi Informatika.
                            </p>
                            <p class="lead">Nomor Pokok Mahasiswa: <strong>[220711686]</strong>.</p>
                        </div>                
                    </div>                    
                 </div>
                 ...
                 <div class="row featurette" style="background-image: url('./assets/images/food.jpg');
                    ...
                    <div class="col-md-7" style="background-color: rgba(0, 0, 0, 0.6); padding: 20px; border-radius: 12px; color: white;">
                        ...
                        <p class="lead">
                            ...
                            handcrafted cocktails, and a warm ambience perfect for any occasion.
                        </p>
            ...
            <!--Footer-->
            <div class="container">
                <footer class="d-flex flex-wrap justify-content-beetween align-items-center py-3 my-4 border-top">
